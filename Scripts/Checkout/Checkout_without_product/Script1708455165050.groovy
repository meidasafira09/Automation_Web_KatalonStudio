...
WebUI.setText(findTestObject('Object Repository/Checkout_pageObject/field_firstName'), 'meida')

WebUI.setText(findTestObject('Object Repository/Checkout_pageObject/field_lastName'), 'safira')

WebUI.setText(findTestObject('Object Repository/Checkout_pageObject/field_postalCode'), '123')
